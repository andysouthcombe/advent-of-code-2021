...
from aoc_day7 import get_crab_sub_position_range,get_move_cost,get_total_move_cost_to_position,get_cheapest_common_position,get_move_cost_part_2,build_cost_dict
...
def test_get_move_cost_part_2():
    assert get_move_cost_part_2(0,1, costs_dict) == 1
    assert get_move_cost_part_2(0,2, costs_dict) == 3
    assert get_move_cost_part_2(2,5, costs_dict) == 6
    assert get_move_cost_part_2(14,5, costs_dict) == 45